    ...
    */}
    <div
      className={cn(
        "text-sm",
        lockedByParent
          ? "mb-2 rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-destructive flex items-start justify-between gap-3"
          : "sr-only",
      )}
    >
      <div
      ...
      >
        {lockedByParent
          ? (lockedReason ??
             "Payment form is temporarily disabled: we couldn't load the latest audit entry needed to safely prefill this payment. Use Retry to try again.")
          : ""}
      </div>
      {lockedByParent && onRetry && (
        <button
